...
(function loader() {
    ...
    function constructCore() {
        ...
        function isInteger(value) {
            ...
            // #NOTE1: Why this?
            // #RE:NOTE1: Because... for some really demented reason, (isNaN("") === false) An empty string is apparently a number?
            if (isString(value)) {
        ...
        function onlyProceedIf(statement, check) {
            ...
            carrierArray[0] = statement;

            if (attempt(check, carrierArray) !== true) {
...
////////////////////////////////////////////////////////////////
        var formatizer = (function constructFormatizer() {
            ...
            function typeCheck(match, position, type_flag) {
                ...
                if (type_check(insert_value) !== true) {
            ...
            function format(supplied_format) {
                ...
                // #NOTE1: arguments_to_format[0] is occupied by the supplied_format which makes the rest 1 based, not 0 based!!! If we ever add more parameters to this function, then we need to build in an offset or split the array. This is flimsy, I don't like this
                // #TODO: Split off the array of arguments to prevent the above noted flimsiness.
